...
import states.downloads.*;

class DownloadMenuState extends MusicBeatState 
{
    var freeplays:Array<String> = ['Mods', 'Character Assets', 'Stage Assets'];
    ...
    function openSelectedSubstate(label:String) {
		switch(label) {
			case 'Mods':
				MusicBeatState.switchState(new DownloadModsMenuState());
		}
	}
