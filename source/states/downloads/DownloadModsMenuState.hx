...
class DownloadModsMenuState extends MusicBeatState 
{
    var freeplays:Array<String> = ['GameBanana ID', 'Other Directlink'];
    ...
    function openSelectedSubstate(label:String) {
		switch(label) {
			case 'GameBanana ID':
				MusicBeatState.switchState(new GameBannaDownloadState());
			case 'Other Directlink':
